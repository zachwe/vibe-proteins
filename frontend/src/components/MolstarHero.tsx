  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      try {
        ...
        // Try RCSB first, fall back to PDBe if it fails
        ...
        try {
          await viewer.loadStructureFromUrl(rcsbUrl, "pdb", false);
        } catch {
          console.warn("RCSB failed, trying PDBe mirror");
          await viewer.loadStructureFromUrl(pdbeUrl, "pdb", false);
        }
